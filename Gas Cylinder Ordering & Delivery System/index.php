...
<body>
    ...
    <div class="container">
        <div class="navbar-header"><a href="index.php" class="navbar-brand navbar-link"><i class="glyphicon glyphicon-fire text-info"></i>شركة التوفير </a>
...
<div class="form-group">
    ...
    <input class="form-control" type="text" name="pin" id="pin" required />
		...
		<div class="form-group">
			...
			<input class="form-control" type="text" name="cmno" id="cmno"
       pattern="05[0-9]{8}" title="أدخل رقمًا سعوديًا صحيحًا مكونًا من 10 أرقام ويبدأ بـ 05"
       maxlength="10" required />
		...
		<input type="email" name="eid" id="eid" required><br>
...
function sub() {
    ...
    return false; // لمنع إرسال النموذج التقليديS
}
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
					...
					<script>
						function myMap() {
						  var myCenter = new google.maps.LatLng(23.4807251,40.8877125,3933);
