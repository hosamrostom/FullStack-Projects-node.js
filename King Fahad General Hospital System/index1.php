...
h1, h2, h3, h4, h5, h6 {
  font-size: 2em !important; /* غيّر الرقم حسب ما تريده */
}

/* تكبير شريط التنقل (navbar) */
.navbar-brand h4,
.navbar-nav .nav-link h6 {
  font-size: 1.5em !important; /* تكبير عناصر الهيدر في الـ Navbar */
  ...
  <body style="background: -webkit-linear-gradient(left, #3931af, #00c6ff); background-size: cover;">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>& مستشفى الملك فهد العام</h4></a>
  ...
  <div class="card" style="font-family: 'IBM Plex Sans', sans-serif; width: 110%; padding: 20px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); border-radius: 10px;">
    <div class="card-body">
      <center>
