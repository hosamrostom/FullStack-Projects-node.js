...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php"> HishamSchool – إدارة ثانوية الحكم بن هشام
</a>
  ...
  <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.05);">
    ...
    <a class="text-body" target="_blank" href=" "> HishamSchool – إدارة ثانوية الحكم بن هشام
</a>
  </div>
  <!-- Copyright -->
</footer>
